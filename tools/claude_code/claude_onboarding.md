...
Watch this [video demo](https://www.youtube.com/watch?v=OwMu0pyYZBc) to see how Claude Code helps modernize a mainframe codebase. It shows you how Claude Code can handle the complex, multi-step work—generating documentation, developing migration plans, writing test suites, and iteratively validating the new code—directly from your terminal.
